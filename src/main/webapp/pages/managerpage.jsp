...
<body>
	...
	<div id="sidebar">
		...
		<p><a href="<c:url value="/vieworderlist"/>">View List Of Orders</a><br>
		<p><a href="<c:url value="/orderhistory"/>">History of orders</a><br>
	...
	<H1>MACHINES:</H1>
<table border="1" style="width:800px" id="tablepaging4" class="yui" align="center">
<tr><th>NUMBER</th> <th>Machine Id</th><th>Serial Number</th> <th>Year</th> <th>Times Repaired</th>
</tr>
<c:forEach var="ms" items="${machines}"  varStatus="loopStatus">  
 <tr class="${loopStatus.index % 2 == 0 ? 'even' : 'odd'}">
    	<td><c:out value="${loopStatus.index + 1}"/></td>
    	  <td>${ms.ms_id}</td>  
    	  <td> ${ms.serial_number}</td> 
    	  <td> ${ms.year}</td>   
    	  <td> ${ms.times_repaired}</td> </tr>  	
    </c:forEach>
    </table>

...
@Controller
public class ViewNewOrdersController  implements MessageSourceAware  {
	@Autowired
	...
	public void setMessageSource(MessageSource messageSource) {
	 ...
	 @RequestMapping(value = "/viewneworders")
	    public String viewdoneorders(Locale locale, Model model, final Principal principal) {
		   log.info("Here you can view done orders: "+ locale.toString());
		      ...
		      //  model.addAttribute("doneOrder",
		        ...
		        for (Order o:os.fetchAllDoneOrDeclinedOrderById(userSvc.getUserByLogin(principal.getName()).getClient().getClientId())){

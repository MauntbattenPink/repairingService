...
import com.glomozda.machinerepair.AddMachineController;
import com.glomozda.machinerepair.OrderMachineRepair_Type;
...
@Controller
public class ManagerMachinesController  implements MessageSourceAware  {
	@Autowired
	...
	public void setMessageSource(MessageSource messageSource) {
	 ...
	 @RequestMapping(value = "/managermachines")
	    public String viewdoneorders(Locale locale, Model model, final Principal principal) {
	        log.info("Here you can view orders history: "+ locale.toString());
	      ...
	      //  model.addAttribute("doneOrder",
	        ...
	        log.info(os.fetchAllUnpendedOrders());
	        for (Order o: os.fetchAllUnpendedOrders()){
	        	omr.add(new OrderMachineRepair_Type(o.getOrder_id(),
	        			o.getStart(), o.getStatus(), o.getClients_id(),
	        			o.getType_id(), o.getMachine_id(),
	        			 rtSvc.fetchAllRepair_TypeById(o.getMachine_id()).getName(),
